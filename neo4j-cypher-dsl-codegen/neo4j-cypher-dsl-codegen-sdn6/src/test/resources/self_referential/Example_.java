...
public final class Example_ extends NodeBase<Example_> {
	...
	public final BelongsTo_ PARENT;

	public Example_() {
		super("Example");
		PARENT = new BelongsTo_(this, new Example_(this));
	}
	...
	private Example_(Example_ backReference) {
		super(null, backReference.getLabels(), backReference.getProperties());
		PARENT = new BelongsTo_(this, backReference);
	}
